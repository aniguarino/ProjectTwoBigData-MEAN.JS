    var expressServer = "http://184.72.169.1:80";
...
$scope.showInfoCarrier = function() {
 ...
 for(var i=0; i<$scope.routeSelected.workingCarrier.length; i++){
  if($scope.currentCarrier.trim() == $scope.routeSelected.workingCarrier[i].UniqueCarrier.trim()){
   ...
   document.getElementById('carrierDetails').innerHTML = document.getElementById('carrierDetails').innerHTML + "<br>Ritardo medio alla partenza dei voli: " + $scope.routeSelected.workingCarrier[i].MeanDepDelay + "<br>Ritardo medio all'arrivo dei voli: " + $scope.routeSelected.workingCarrier[i].MeanArrDelay;
